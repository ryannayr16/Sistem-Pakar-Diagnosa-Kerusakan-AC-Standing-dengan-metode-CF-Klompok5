...
public class Diagnosa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kem = findViewById(R.id.butkemdiag);
        ...
        lngs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selected == -1) {
                    ...
                    if (nilaiLebihDari02.size() >= 2) {
                        langsung();
                    }else{
                        Toast.makeText(Diagnosa.this, "Harus memilih 2 Gejala", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        kem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Diagnosa.this, HomeDash.class);
    ...
    private void showPertanyaan(int index) {
        if (index >= dtgj.size()) {
            ...
            pertanyaan.setText("Apakah AC anda mengalami " + item.getNamaGejala()+ " ?");
